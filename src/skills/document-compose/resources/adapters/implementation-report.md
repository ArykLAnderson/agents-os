...
**Structure mode:** recommended. Keep verification and limitations visible even when local conventions change section names.
...
Route a new accepted outcome, changed requirement, or unsupported completion claim to `document-reconcile`.
