...
- **Blueprint owns the selected internal responsibility/contract/state design** needed to meet that boundary. Blueprint and Route lenses are coupled: design checks whether a vertical route is possible; routeability exposes missing ownership or seams and returns to design. Neither is a phase gate.
