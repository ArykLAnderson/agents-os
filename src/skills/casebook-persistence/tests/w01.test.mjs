...
test("manifest validates all canonical runtime asset bytes and compatibility identities", async () => {
  ...
  assert.deepEqual(check.manifest.implemented_slice_constraints, {
    ...
    markdown_profile: "exclusive Markdown installation with L01 synthetic parity plus digest-guarded atomic file-authoritative Case replacement; coherent Frame generation remains later L-05 work",
