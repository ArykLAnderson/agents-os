...
test("manifest validates all canonical runtime asset bytes and compatibility identities", async () => {
  ...
  assert.deepEqual(check.manifest.implemented_slice_constraints, {
    ...
    markdown_profile: "exclusive Markdown installation state with L01 synthetic interchange operations only; atomic replacement and coherent generation remain later L-05 work",
