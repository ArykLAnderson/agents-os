...
test("manifest validates all canonical runtime asset bytes and compatibility identities", async () => {
  ...
  assert.deepEqual(check.manifest.implemented_slice_constraints, {
    ...
    markdown_profile: "exclusive Markdown installation with L01 synthetic parity, digest-guarded atomic Case replacement, and manifest-selected coherent Frame/Discovery/disposition generations",
