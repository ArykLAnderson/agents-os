...
export async function loadAndValidateManifest() {
  ...
  const expectedOperationContracts = new Map([
    ...
    ["namespace.create", ["ordinary_cli", "context.manage", "namespace"]], ["namespace.revise", ["human_operational", "context.manage", "namespace"]], ["namespace.retire", ["human_operational", "context.manage", "namespace"]], ["namespace.read", ["ordinary_cli", "context.read", "namespace"]], ["namespace.list", ["ordinary_cli", "context.read", "namespace"]], ["namespace.history", ["ordinary_cli", "context.read", "namespace"]], ["namespace.resolve", ["internal", "context.read", "namespace"]],
