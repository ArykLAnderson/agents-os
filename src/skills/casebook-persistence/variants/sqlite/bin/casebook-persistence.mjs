...
try {
  ...
  } else if (["frame.create", "frame.commit_revision", "frame.resolve", "frame.read", "frame.discovery.read", "frame.history", "frame.list", "frame.legacy.prepare_reconciliation"].includes(request.operation)) {
