...
CREATE TABLE context_namespace_revisions (
  ...
  namespace_id TEXT NOT NULL REFERENCES owners(owner_id) CHECK(namespace_id LIKE 'namespace:%' AND namespace_id NOT GLOB '*[^a-z0-9:/-]*' AND namespace_id NOT LIKE 'namespace:' AND namespace_id NOT LIKE 'namespace:/%' AND namespace_id NOT LIKE '%//%' AND namespace_id NOT LIKE '%/' AND namespace_id NOT LIKE 'namespace:-%' AND namespace_id NOT LIKE '%/-%' AND namespace_id NOT LIKE '%-/%' AND namespace_id NOT LIKE '%--%' AND namespace_id NOT LIKE '%-' AND namespace_id NOT LIKE 'namespace:%:%' AND (length(namespace_id) - length(replace(namespace_id, '/', ''))) <= 7 AND namespace_id NOT GLOB '*[/:][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[1-5][0-9a-f][0-9a-f][0-9a-f]-[89ab][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]' AND namespace_id NOT GLOB '*[/:][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[1-5][0-9a-f][0-9a-f][0-9a-f]-[89ab][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]/*'),
  revision_number INTEGER NOT NULL CHECK(revision_number > 0),
  parent_namespace_id TEXT REFERENCES owners(owner_id) CHECK(parent_namespace_id IS NULL OR (parent_namespace_id LIKE 'namespace:%' AND parent_namespace_id NOT GLOB '*[^a-z0-9:/-]*' AND parent_namespace_id NOT LIKE 'namespace:' AND parent_namespace_id NOT LIKE 'namespace:/%' AND parent_namespace_id NOT LIKE '%//%' AND parent_namespace_id NOT LIKE '%/' AND parent_namespace_id NOT LIKE 'namespace:-%' AND parent_namespace_id NOT LIKE '%/-%' AND parent_namespace_id NOT LIKE '%-/%' AND parent_namespace_id NOT LIKE '%--%' AND parent_namespace_id NOT LIKE '%-' AND parent_namespace_id NOT LIKE 'namespace:%:%' AND (length(parent_namespace_id) - length(replace(parent_namespace_id, '/', ''))) <= 7 AND parent_namespace_id NOT GLOB '*[/:][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[1-5][0-9a-f][0-9a-f][0-9a-f]-[89ab][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]' AND parent_namespace_id NOT GLOB '*[/:][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[1-5][0-9a-f][0-9a-f][0-9a-f]-[89ab][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]/*')),
...
CREATE TABLE context_project_default_revisions (
  ...
  revision_number INTEGER NOT NULL CHECK(revision_number > 0),
  namespace_id TEXT CHECK(namespace_id IS NULL OR (namespace_id LIKE 'namespace:%' AND namespace_id NOT GLOB '*[^a-z0-9:/-]*' AND namespace_id NOT LIKE 'namespace:' AND namespace_id NOT LIKE 'namespace:/%' AND namespace_id NOT LIKE '%//%' AND namespace_id NOT LIKE '%/' AND namespace_id NOT LIKE 'namespace:-%' AND namespace_id NOT LIKE '%/-%' AND namespace_id NOT LIKE '%-/%' AND namespace_id NOT LIKE '%--%' AND namespace_id NOT LIKE '%-' AND namespace_id NOT LIKE 'namespace:%:%' AND (length(namespace_id) - length(replace(namespace_id, '/', ''))) <= 7 AND namespace_id NOT GLOB '*[/:][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[1-5][0-9a-f][0-9a-f][0-9a-f]-[89ab][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]' AND namespace_id NOT GLOB '*[/:][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f]-[1-5][0-9a-f][0-9a-f][0-9a-f]-[89ab][0-9a-f][0-9a-f][0-9a-f]-[0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f][0-9a-f]/*')),
  lifecycle TEXT NOT NULL CHECK(lifecycle IN ('active','retired')),
