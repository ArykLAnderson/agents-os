...
CREATE TABLE context_namespace_revisions (
  ...
  namespace_id TEXT NOT NULL REFERENCES owners(owner_id) CHECK(namespace_id LIKE 'namespace:%' AND namespace_id NOT GLOB '*[^a-z0-9:/-]*' AND namespace_id NOT LIKE 'namespace:' AND namespace_id NOT LIKE 'namespace:/%' AND namespace_id NOT LIKE '%//%' AND namespace_id NOT LIKE '%/' AND namespace_id NOT LIKE 'namespace:-%' AND namespace_id NOT LIKE '%/-%' AND namespace_id NOT LIKE '%--%' AND namespace_id NOT LIKE '%-' AND namespace_id NOT LIKE 'namespace:%:%' AND namespace_id NOT GLOB 'namespace:????????-????-????-????-????????????'),
  revision_number INTEGER NOT NULL CHECK(revision_number > 0),
  parent_namespace_id TEXT REFERENCES owners(owner_id) CHECK(parent_namespace_id IS NULL OR (parent_namespace_id LIKE 'namespace:%' AND parent_namespace_id NOT GLOB '*[^a-z0-9:/-]*' AND parent_namespace_id NOT LIKE 'namespace:' AND parent_namespace_id NOT LIKE 'namespace:/%' AND parent_namespace_id NOT LIKE '%//%' AND parent_namespace_id NOT LIKE '%/' AND parent_namespace_id NOT LIKE 'namespace:-%' AND parent_namespace_id NOT LIKE '%/-%' AND parent_namespace_id NOT LIKE '%--%' AND parent_namespace_id NOT LIKE '%-' AND parent_namespace_id NOT LIKE 'namespace:%:%' AND parent_namespace_id NOT GLOB 'namespace:????????-????-????-????-????????????')),
...
CREATE TABLE context_project_default_revisions (
  ...
  revision_number INTEGER NOT NULL CHECK(revision_number > 0),
  namespace_id TEXT CHECK(namespace_id IS NULL OR (namespace_id LIKE 'namespace:%' AND namespace_id NOT GLOB '*[^a-z0-9:/-]*' AND namespace_id NOT LIKE 'namespace:' AND namespace_id NOT LIKE 'namespace:/%' AND namespace_id NOT LIKE '%//%' AND namespace_id NOT LIKE '%/' AND namespace_id NOT LIKE 'namespace:-%' AND namespace_id NOT LIKE '%/-%' AND namespace_id NOT LIKE '%--%' AND namespace_id NOT LIKE '%-' AND namespace_id NOT LIKE 'namespace:%:%' AND namespace_id NOT GLOB 'namespace:????????-????-????-????-????????????')),
  lifecycle TEXT NOT NULL CHECK(lifecycle IN ('active','retired')),
