...
- **Review briefing:** orient reviewers to scope and risk, then walk through changed surfaces, evidence, open concerns, and review asks.
- **Mental model:** ground familiar concepts first, introduce the mechanism progressively, test it with examples and boundaries, then transfer it to new situations.
