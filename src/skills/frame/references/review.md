...
Independently challenge a coherent direction. Review after one emerges, earlier only when framing itself may be materially flawed, and repeat only for perspectives affected by material change.

Generate only the independent review mandates justified by the actual claims, risks, affected parties, evidence quality, and intended outcome. Consider security and privacy, product effects, technical structure, operations, analytical method, and organizational change only when relevant.
