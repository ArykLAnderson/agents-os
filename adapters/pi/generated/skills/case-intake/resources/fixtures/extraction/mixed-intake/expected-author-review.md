...
- Preserve inspectable provenance for supplied intake artifacts.
- Register each supplied artifact before semantic extraction.
- Treat review-burden reduction as a desired outcome, not a measured result.
