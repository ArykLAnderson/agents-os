...
Use this shape to communicate the single accepted policy. A separate implementation-planning artifact requires accepted owner, schedule, rollout, and authorization facts before it can make those claims.
