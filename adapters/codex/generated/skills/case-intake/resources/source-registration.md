...
3. Normalize each artifact into a source entry using the DS-001 source contract.
...
- Local file: use the project-relative or bundle-relative path supplied by the fixture or author.
...
Line numbers are acceptable only when the supplied source or fixture uses them as the stable locator. Prefer symbols, headings, timestamps, block URLs, or semantic anchors when available.
