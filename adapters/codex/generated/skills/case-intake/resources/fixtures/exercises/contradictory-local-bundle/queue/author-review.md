...
### ARI-001: Capacity evidence contradicts the accepted retry limit

- **State:** needs-author
- **Materiality:** blocking
- **Trigger:** later evidence
- **Question:** Should the current migration policy change from three to four retries now that validation rejects three, supports four, and rejects five?
- **Why it matters:** The pinned RFC currently tells reviewers that three retries is current policy; continuing with that claim would conceal a material operational conflict.
