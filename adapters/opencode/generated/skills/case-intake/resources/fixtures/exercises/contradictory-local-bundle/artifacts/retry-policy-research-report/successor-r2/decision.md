...
- **Snapshot:** `notification-retry-policy/SNAP-005`
...
- **Representation correction:** `APR-005` verifies this snapshot representation without changing accepted retry-policy meaning or reader action.
