...
- **Validation:** compare node labels and status to trace; inspect desktop and narrow layout; verify each grouped connector joins only its immediately adjacent lifecycle nodes and no connector bypasses the publication gate.
